  ...
  <body>
    ...
    >
      <!-- Desktop sidebar -->
      <aside
        class="z-20 hidden w-64 overflow-y-auto bg-white 
        dark:bg-gray-800 md:block flex-shrink-0">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container flex flex-col items-center px-6 mx-auto">
            ...
            <p class="text-gray-700 dark:text-gray-300">
              Page not found. Check the address or <strong>go back</strong> 
            </p>
          </div>
        </main>
      </div>
